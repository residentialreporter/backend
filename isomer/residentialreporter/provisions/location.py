...
def provision_locations(items, database_name, overwrite=False,
                        clear=False, skip_user_check=False):

    from isomer.provisions.base import provisionList
    from isomer.database import objectmodels

    provisionList(locations, 'location',
                  overwrite, clear, skip_user_check)

    log('Provisioning: Locations: Done.', emitter='PROVISIONS')


provision = {
    'data': locations,
    'method': provision_locations
}
